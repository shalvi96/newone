...
//het shah shalvi nanavati
	...
	//$con=mysql_connect('shalvi.db.9462939.hostedresource.com','shalvi','Demo2@9898');
		//mysql_select_db('shalvi',$con);
  while ($row=mysql_fetch_assoc($res)) {
    ...
    echo '<script language="javascript">;
                    ...
                    window.location.href="mainheader.php";
                    </script>';
	}
	}
?>
    ...
    <div class="modal-content">
      ...
      <h6 align="left">Email-id</h6>
        <div class="input-group">
             <input type="text" class="form-control" name="txtemail" required placeholder="Recipient's Email-Id" aria-describedby="basic-addon2">
                 <span class="input-group-addon" id="basic-addon2">@example.com</span>
            </div>
           <h6 align="left">User Name</h6>
            <div class="input-group">
                <span class="input-group-addon" id="basic-addon1">@</span>
                 <input type="text" class="form-control" name="txtname" required placeholder="Username" aria-describedby="basic-addon1">
            </div>
            <h6 align="left">Password</h6>
            <div class="input-group">
                <span class="input-group-addon" id="basic-addon1">*</span>
                 <input type="password" class="form-control" name="txtpass" required placeholder="Password" aria-describedby="basic-addon1">
            </div>
            <h6 align="left">Confirm Password</h6>
            <div class="input-group">
                <span class="input-group-addon" id="basic-addon1">*</span>
                 <input type="password" class="form-control" name="txtpass1" required placeholder="Confirm Password" aria-describedby="basic-addon1">
            </div>
            <h6 align="left">Mobile No</h6>
            <div class="input-group">
                <span class="input-group-addon" id="basic-addon1">+91</span>
                 <input type="text" class="form-control" name="txtmob" required placeholder="Mobile No" aria-describedby="basic-addon1">
            </div>
            </br>
